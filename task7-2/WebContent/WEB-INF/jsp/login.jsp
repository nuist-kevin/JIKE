        ...
        <div class="col-lg-12">
            <s:form namespace="/" method="post" action="login" class="bootstrap-admin-login-form">
                <div class="form-group">
                    <s:textfield class="form-control" name="username" placeholder="请输入用户名"></s:textfield>
                </div>
                <div class="form-group">
                    <s:password class="form-control" name="password" placeholder="请输入密码"></s:password>
                </div>
                <s:submit class="btn btn-lg btn-primary" value="登录"></s:submit>
            </s:form>
        </div>
    </div>
</div>
