...
/**
 * Descriton:
 * <br> 任务 7: SSH框架之Hibernate入门
 * <br> 1、［使用HQL实现］输出数据中名字为三个字的诗人列表及其诗词的数量统计。格式如：姓名 － 诗词数量
 * <br> 2、分页输出诗人李白所有诗词的标题，要求每10个标题分为1页，输出的数据格式如下：
 * <br> 诗人李白相关的数据总共 XXX页。
 * <br> 第一页内容：
 * <br> 《。。。》
 * <br> 《。。。》
 ...
 * <br> 《。。。》
 * <br>
 * <br> 3、［使用关联映射实现］输出某一个诗人所有的诗词前15个字（包括标点符号），这个诗人的名字要求用户输入，敲回车后进行查询操作。
 * <br>
 *
 * @author caiwen
 * @version 1.0
...
public class PoetryTest {
    ...
    public static void main(String[] args) {
        ...
        while (scanner.hasNext()) {
            ...
            Query query = session.createQuery("select substring(pp.content, 1, 15) from Poet p join p.poetries pp where p.name = :name");
